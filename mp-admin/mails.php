		...
		foreach ( $columns as $column_name => $column_display_name ) 
		{
			...
			switch ( $column_name ) 
			{
				...
				case 'title':
					...
					{
						$out .= '<span class="icon paused" title="' . esc_attr( __( 'Paused', 'MailPress' ) ) . '"></span>';
					}
					if ( $attach )
					{
						$out .= '<span class="icon attachment" title="' . esc_attr( __( 'Attachments', 'MailPress' ) ) . '"></span>';
					}
					if ( ( 'draft' == $mail->status ) && ( $mp_mail->sent >= $mp_mail->created ) )
					{
						$out .= '<span class="icon scheduled" title="' . esc_attr( __( 'Scheduled', 'MailPress' ) ) . '"></span>';
					}
