...
$template 		= ( isset( $_GET['template'] ) ) ? $_GET['template'] : reset( $templates );
...
<?php MP_AdminPage::select_option( $templates, $template ); ?>
	...
	<form name="Template" id="Template" method="post">
		...
		<div classe="template">
			<textarea name="newcontent" id="newcontent" tabindex="1" rows="30" cols="100"><?php echo $content ?></textarea>
		</div>
<?php if ( $file_status ) : ?>
