...
$content .= '<tr><th>';
$content .= sprintf( '<a href="%1$s" target="_blank">%2$s</a>', 'https://en.wikipedia.org/wiki/Bounce_message', __( 'Handling Bounces II', 'MailPress' ) );
$content .= '</th><td>';
$content .= __('to discard failing recipients from future mailing.', 'MailPress' );
$content .= ' ';
$content .= __( '( based on mail headers & string detection in mail body ).', 'MailPress' );
$content .= '</td></tr>';
