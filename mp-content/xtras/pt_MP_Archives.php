...
?>
		<div id="mail-<?php $m->the_ID(); ?>">
			<h2 class="entry-title"><a href="<?php $m->the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'twentyten' ), $m->get_the_subject() ) ); ?>" rel="bookmark"><?php $m->the_subject(); ?></a></h2>
