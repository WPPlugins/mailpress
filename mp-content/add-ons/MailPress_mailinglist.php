...
// for wp admin
		...
		// for settings general
			add_filter( 'MailPress_settings_general_help',	array( __CLASS__, 'settings_general_help' ), 30, 1 );
			add_action( 'MailPress_settings_general_update',array( __CLASS__, 'settings_general_update' ), 30 );
			add_action( 'MailPress_settings_general_form',	array( __CLASS__, 'settings_general_form'), 30 );
...
// for settings general
	...
	{
		include ( MP_ABSPATH . 'mp-admin/includes/settings/general/mailinglist/help.php' );
		return $content;
	}

	public static function settings_general_update()
	{
		include ( MP_ABSPATH . 'mp-admin/includes/settings/general/mailinglist/update.php' );
	}

	public static function settings_general_form()
	{
		include ( MP_ABSPATH . 'mp-admin/includes/settings/general/mailinglist/form.php' );
	}
...
<div id="mailinglist-adder" class="wp-hidden-children">
	...
	<p id="mailinglist-add" class="wp-hidden-child">
		...
		<input type="text" name="newmailinglist" id="newmailinglist" class="form-required form-input-tip" value="<?php echo esc_attr( __( 'New mailing list', 'MailPress' ) ); ?>" tabindex="3" aria-required="true"/>
		<label class="screen-reader-text">
			<?php _e( 'Parent Mailing list', 'MailPress' ); ?> :
		</label>
		<?php MP_Mailinglist::dropdown( array( 'hide_empty' => 0, 'htmlname' => 'newmailinglist_parent', 'orderby' => 'name', 'hierarchical' => 1, 'show_option_none' => __( 'Parent Mailing list', 'MailPress' ), 'tab_index' => 3 ) ); ?>
		<input type="button" id="mailinglist-add-submit" class="add:mailinglistchecklist:mailinglist-add button" value="<?php echo esc_attr( __( 'Add', 'MailPress' ) ); ?>" tabindex="3" />
...
?>
		<li id="<?php echo $id; ?>" class="popular-mailinglist">
			...
			<input type="checkbox" id="in-<?php echo $id; ?>" value="<?php echo ( int ) $mailinglist->term_id; ?>" />
...
?>
										<label for="visitor_mailinglist"><small><?php _e( 'Mailing list', 'MailPress' ); ?></small></label>
<?php
