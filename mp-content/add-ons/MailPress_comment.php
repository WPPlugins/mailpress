...
<div class="MailPressCommentform" style="clear:both;">
	<span><?php printf( __( 'You are subscribed to this entry. %1$s.', 'MailPress' ), sprintf( '<a href="%1$s">%2$s</a>', $url, __( 'Manage your subscriptions', 'MailPress' ) ) ); ?></span>
</div>
...
<div class="MailPressCommentform" style="clear:both;">
	...
	<label for="MailPress_subscribe_to_comments">
		<input name="MailPress[subscribe_to_comments]" id="MailPress_subscribe_to_comments" type="checkbox" class="MailPressCommentformCheckbox" style="margin:0;padding:0;width:auto;"<?php checked( get_option( self::option ) ); ?> />
