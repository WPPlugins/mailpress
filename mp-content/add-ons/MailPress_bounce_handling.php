...
class MailPress_bounce_handling
{
	...
	const process_name		= 'mp_process_bounce_handling';
...
// for settings batches
	...
	{
		include ( MP_ABSPATH . 'mp-admin/includes/settings/batches/bounce_handling/help.php' );
		return $content;
	}

	public static function settings_batches_update()
	{
		include ( MP_ABSPATH . 'mp-admin/includes/settings/batches/bounce_handling/update.php' );
	}

	public static function settings_batches_form()
	{
		include ( MP_ABSPATH . 'mp-admin/includes/settings/batches/bounce_handling/form.php' );
	}

// for settings pop3
	public static function settings_connection_pop3_update()
	{
		include ( MP_ABSPATH . 'mp-admin/includes/settings/connection_pop3/bounce_handling/form.php' );
	}

// for settings logs	
	public static function settings_logs_form( $logs )
	{
		MP_AdminPage::logs_sub_form( self::log_name, $logs, __( 'Bounce', 'MailPress' ) );
	}
