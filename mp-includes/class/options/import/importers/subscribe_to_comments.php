...
<div>
	...
	<form method="post" action="<?php echo esc_url( add_query_arg( $args, MailPress_import ) ); ?>">
		<p class="submit">
			<input type="submit" name="Submit" class="button-primary" value="<?php  _e( 'Continue', 'MailPress' ); ?>" />
		</p>
	</form>
</div>
<?php
...
new MP_import_subscribe_to_comments( __( 'Import data from <strong>subscribe to comments</strong> plugin.', 'MailPress' ), __( 'Import from Subscribe to comments', 'MailPress' ) );