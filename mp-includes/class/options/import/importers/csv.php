...
// step 2
	...
	function import( $id ) 
	{
		...
		$mailinglist_ok = ( class_exists( 'MailPress_mailinglist' ) && ( '-1' != $_POST['mailinglist'] ) );
		if ( $mailinglist_ok )
		{
		...
		$newsletter_ok 	  = ( class_exists( 'MailPress_newsletter' ) && isset( $_POST['newsletter'] ) );
		$no_newsletter_ok = ( class_exists( 'MailPress_newsletter' ) && isset( $_POST['no_newsletter'] ) );
