<?php
class MP_Dashboard_users_per_post extends MP_WP_Dashboard_widget_
{
...
<img style="width:100%;" src="<?php echo $url; ?>" alt="<?php _e( 'Comments subscribers per post', 'MailPress' ); ?>" />
</div>
<?php
	}
...
new MP_Dashboard_users_per_post( __( 'MailPress - Comments subscribers per post', 'MailPress' ) );