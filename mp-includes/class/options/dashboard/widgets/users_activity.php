<?php
class MP_Dashboard_users_activity extends MP_WP_Dashboard_widget_
{
	...
	function widget()
	{
		...
		$libs  = array( 'waiting' => __( 'waiting', 'MailPress' ),  'comment' => __( 'comment%20only', 'MailPress' ), 'active' => __( 'active', 'MailPress' ), );
...
?>
<div style="text-align:center;"><img style="width:100%;" src="<?php echo $url; ?>" alt="<?php _e( 'Subscribers - Activity', 'MailPress' ); ?>" />
</div>
<?php
	}
}
new MP_Dashboard_users_activity( __( 'MailPress - Subscribers activity', 'MailPress' ) );