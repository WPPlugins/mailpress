...
/*
$out = '';
$out .= '=== ' . $addon_data['Title'] . ' ===' . "\r\n";
$out .= 'Plugin Name: ' . $addon_data['Title'] . "\r\n";
$out .= 'Plugin URI: ' . $addon_data['PluginURI'] . "\r\n";
$out .= 'Description: ' . strip_tags( $addon_data['Description'] ) . "\r\n";
$out .= 'Version: ' . $addon_data['Version'] . "\r\n\r\n";
$out .= "== Description ==\r\n\r\n\r\n";
$out .= "== Installation ==\r\n\r\n\r\n";
$out .= "== Upgrade Notice ==\r\n\r\n\r\n";
...
$out .= "== Screenshots ==\r\n\r\n\r\n";
$out .= "== Changelog ==\r\n\r\n\r\n";
$fr = ABSPATH . PLUGINDIR . "/" . substr( $addon_file, 0, -4 ) . ".readme.txt";
file_put_contents( $fr, $out );
*/
	...
	public static function is_active( $string, $header = 'Name' ) 
	{
		$mp_addons = self::get_all();

		foreach( $mp_addons as $k => $v )
		{
			...
			switch ($header)
			{
				...
				break;
				default :
					if ( isset( $v[$header] ) && ( $v[$header] == $string ) ) return true;
				break;
			}
		}
