...
class MP_Form_field
{
	...
	public static function insert_visitor_email( $form_id ) 
	{
		...
		$data['label'] 		= __( 'Email', 'MailPress' );		$format[] = '%s';
		$data['description'] 	= __( 'Visitor email', 'MailPress' );	$format[] = '%s';
		$data['settings'] 	= serialize( $settings );			$format[] = '%s';
	...
	public static function insert_visitor_name( $form_id ) 
	{
		...
		$data['template']		= 'standard';				$format[] = '%s';
		$data['label'] 		= __( 'Name', 'MailPress' );		$format[] = '%s';
		$data['description'] 	= __( 'Visitor name', 'MailPress' );	$format[] = '%s';
		$data['settings'] 	= serialize( $settings );			$format[] = '%s';
	...
	public static function insert_visitor_mail( $form_id ) 
	{
		...
		$data['template']		= 'standard';					$format[] = '%s';
		$data['label'] 		= __( 'Mail sent if checked', 'MailPress' );	$format[] = '%s';
		$data['description'] 	= __( 'Check to get a copy', 'MailPress' );	$format[] = '%s';
		$data['settings'] 	= serialize( $settings );				$format[] = '%s';
