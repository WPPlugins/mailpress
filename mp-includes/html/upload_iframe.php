	...
	<body style="margin:0;padding:0;overflow:hidden;background:transparent;">
		<form id="upload_form_<?php echo $id; ?>" action="<?php echo admin_url( 'admin-ajax.php' ); ?>" method="POST" enctype="multipart/form-data" style="margin:0;padding:0;overflow:hidden;cursor:default;">
			...
			<label class="mp_fileupload_file" id="mp_fileupload_file" style="cursor:default;height:24px;width:132px;display:block;overflow:hidden;background:transparent url( images/upload.png ) repeat;">
				<input type="file" name="async-upload" id="mp_fileupload_file_<?php echo $id; ?>" style="cursor:default;height:24px;width:132px;margin:0;opacity:0;-moz-opacity:0;filter:progid:DXImageTransform.Microsoft.Alpha( opacity=0 );position:relative;" />
			</label>
